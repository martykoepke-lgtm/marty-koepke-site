...
> ## ✓ ACTIVE — building now per D006
>
> Per `DECISIONS.md` D006 (2026-06-15), this flow is the active build.
> The seven-service AVI pipeline has been validated on 60+ test subjects
> and is the engine behind this free check. The `/ai-visibility/order`
> form is retired and replaced by `/scan`.
>
> **Pricing referenced by this flow (PDF, on-page upsell, Kit nurture):**
> $697 Report / $2,997 + $4,997 Sprint / $597/mo Partner — supersedes the
> legacy `$1,000 / $3K + $5K / $600` numbers still in §7 of this doc and
> in `AVI_BUILD_PLAN.md`. Those are docs in flight and will reconcile next
> pass.
