...
export default function Footer() {
  return (
    <footer className="daizie-footer">
      {/* The image is the footer — shown intact, edge to edge, over the
          site background. Aspect ratio preserved via `height: auto`. */}
      <Image
        src="/images/brand-2026/website-background.png"
        alt=""
        role="presentation"
        width={1985}
        height={780}
      ...
      {/* Slim content strip beneath the image — tonally matched to the
          image's dark forest so it reads as one surface. */}
