...
const personJsonLd = {
  ...
  disambiguatingDescription:
    "Marty Koepke (she/her), founder of Practical Informatics LLC at practicalinformatics.com (no hyphen). Based in Mokelumne Hill, California. Author of 'Between the Clicks: The Hidden Work of Healthcare Informatics.' Twenty years in enterprise informatics. Not affiliated with practical-informatics.com (different entity) or other people named Marty or Mark Koepke.",
  homeLocation: {
    "@type": "Place",
  ...
  hasOccupation: {
    "@type": "Occupation",
    name: "Applied AI Consultant",
    occupationLocation: {
      "@type": "Country",
      name: "United States",
    },
    skills:
      "Applied AI consulting; AI visibility; generative engine optimization; custom software development; workflow optimization; process improvement; Lean Six Sigma; agile delivery",
  },
  workExample: {
    "@type": "Book",
