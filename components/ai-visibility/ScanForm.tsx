  ...
  return (
    <form onSubmit={onSubmit} className="space-y-7" noValidate>
      ...
      <Field
        ...
        type="text"
        required
        placeholder="e.g. small-business AI consultant in the California foothills"
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-moss">
          Optional. Example: <em>&ldquo;Best small-business AI consultant in Calaveras County, California.&rdquo;</em>
        </p>
        <textarea
          id="target_query"
          name="target_query"
