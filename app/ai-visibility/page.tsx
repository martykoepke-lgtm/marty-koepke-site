  ...
  offers: [
    {
      ...
      price: "0",
      priceCurrency: "USD",
      description: "Preliminary AVI score and 2–3 surface findings.",
    },
    {
      "@type": "Offer",
      ...
      priceCurrency: "USD",
      description:
        "Full audit with live queries against ChatGPT, Claude, and Gemini, competitor comparison, top 10 prioritized fixes, and a 30-min walk-through call.",
    },
    {
      "@type": "Offer",
      ...
      priceCurrency: "USD",
      description:
        "Two-week implementation of every fix in the AI Visibility Report, plus a 60-day re-scan.",
    },
  ],
};
    ...
    <>
      ...
      <Section tone="cream" width="narrow" className="text-center">
        <Reveal>
          ...
          <div className="mt-9">
            <Button href="/ai-visibility/order">
              Order the AVI
